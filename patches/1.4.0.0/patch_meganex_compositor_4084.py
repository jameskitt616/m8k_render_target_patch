...
output_file = "MeganeX_Compositor.4084.exe"

byte_diffs = {
    # 0x1FE8 is 8168 (4084*2) as an int. This determines the combined width of
    # the two render targets (left eye + right eye)
    0x4e353: bytes([0xb8, 0xe8, 0x1f, 0x00, 0x00, 0x90, 0x48, 0x90]),
    # 0x7f40 is 4084 as a float. The two middle diffs are used as inputs to the
    # shader doing the downscale and warp.
    0x4e392: bytes([0x40, 0x7f]),
    0x4e39d: bytes([0x40, 0x7f]),
    # 0x0ff4 is 4084 as an int, used to determine the render targets' height.
    0x4e3ac: bytes([0xf4, 0x0f])
}
